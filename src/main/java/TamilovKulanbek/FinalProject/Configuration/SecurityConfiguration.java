    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().cors()
                ...
                .and()
                    ...
                    .antMatchers(HttpMethod.GET, "/item/*").hasRole("MANAGER")
                    .antMatchers(HttpMethod.POST, "/item/**").hasRole("MANAGER")
                    .antMatchers(HttpMethod.POST, "/item").hasRole("MANAGER")
                    .antMatchers(HttpMethod.DELETE, "item/**").hasRole("ADMIN")

                    .antMatchers(HttpMethod.GET, "/order").hasRole("USER")
                    .antMatchers(HttpMethod.GET, "/order/**").hasAnyRole("USER", "MANAGER")
                    ...
                    .antMatchers(HttpMethod.POST, "/wallet/replenish").hasAnyRole("ADMIN", "MANAGER","USER")
                    .antMatchers(HttpMethod.GET, "/wallet").hasRole("ADMIN")
                    .antMatchers(HttpMethod.GET, "/wallet/my").hasAnyRole("ADMIN", "MANAGER","USER")
